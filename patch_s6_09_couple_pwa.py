"""
Session 6 — Patch 9: Couple PWA
Creates web/app/couple/page.tsx — complete couple web experience.
4-tab nav (Discover, Moodboard, Planner, Inbox), Journey View,
free discovery, Pinterest moodboard, tier-aware.
"""
import os

os.makedirs('web/app/couple', exist_ok=True)

couple_pwa = r''''use client';
...
with open('web/app/couple/page.tsx', 'w') as f:
    f.write(couple_pwa)

print("✓ web/app/couple/page.tsx — Couple PWA created")
print("  4-tab nav: Discover · Moodboard · Planner · Inbox")
print("  Journey View with phase cards, progress strip, mode toggle")
print("  Budget-tier-aware greetings and phase subtitles")
print("  Platinum gating with upgrade modal")
print("  Tools route to 'use mobile app' prompt (full tool UIs next session)")
print("  Accessible at: thedreamwedding.in/couple")
print()
print("PATCH 9 COMPLETE")
print("Run: npx tsc --noEmit -p web/tsconfig.json")
