...
# Resolve server.js relative to where this script lives.
# Works on any machine: /home/claude/..., /workspaces/dream-wedding/..., etc.
# Requires the script to be placed at the repo root (next to package.json).
...
if not os.path.exists(SERVER):
    ...
    print(f"  Place this script at the dream-wedding repo root (next to package.json).")
    sys.exit(1)
