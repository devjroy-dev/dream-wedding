"""
Session 6 — Patch 3: Journey Config
Creates constants/journeyConfig.ts — phases, budget tiers, content variants.
This is the data backbone of the new Planner.
"""
...
print("✓ constants/journeyConfig.ts — created")
print("  Journey phases: foundation → search → team → coordination → final → wedding_week")
print("  Budget tiers: essential (<15L) / signature (15-50L) / luxe (50L+)")
print("  Quick access tools, vendor categories, WhatsApp invite template")
print()
